javascript:(function() {
    ...
    for (var i=0, j=showPnxLinkElem.length; i < j; i++) {
        var showPnxRecId = showPnxLinkElem[i].querySelector('.list-item-primary-content').getAttribute('data-recordid'),
            ...
            showLibWBLinkHref = '../primo_library/libweb/static_htmls/librariansWB.html#'+showPnxRecId,
            showLibWBLink = createLink(showLibWBLinkHref, showPnxRecId),
        ...
        recordIdSpan.appendChild(showLibWBLink);
